...
def ingest() -> pd.DataFrame:
    """Adapter skeleton for EIA International.
    ...
    """
    marker = config.RAW / "eia" / "MANUAL_INGESTION_REQUIRED.txt"
    marker.parent.mkdir(parents=True, exist_ok=True)
    marker.write_text("EIA International requires manual/public export review for this portfolio build.\n", encoding="utf-8")
    return pd.DataFrame()
