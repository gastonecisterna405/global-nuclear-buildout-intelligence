...
def ingest() -> pd.DataFrame:
    """Adapter skeleton for IAEA PRIS.
    ...
    """
    marker = config.RAW / "iaea_pris" / "MANUAL_INGESTION_REQUIRED.txt"
    marker.parent.mkdir(parents=True, exist_ok=True)
    marker.write_text("IAEA PRIS requires manual/public export review for this portfolio build.\n", encoding="utf-8")
    return pd.DataFrame()
